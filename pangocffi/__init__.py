...
def pango_version_check(required_major: int, required_minor: int, required_micro: int) -> Optional[str]:
    """Return the pango version number as a string, such as ``1.42.4``."""
    check = pango.pango_version_check(required_major, required_minor, required_micro)
